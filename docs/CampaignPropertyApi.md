...
[**postV4ApiCampaignPropertySearch**](CampaignPropertyApi.md#postV4ApiCampaignPropertySearch) | **POST** /v4/api/campaign-property | 
...
<a name="postV4ApiCampaignPropertySearch"></a>
# **postV4ApiCampaignPropertySearch**
> CampaignProperty postV4ApiCampaignPropertySearch(body)
...
try {
    CampaignProperty result = apiInstance.postV4ApiCampaignPropertySearch(body);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling CampaignPropertyApi#postV4ApiCampaignPropertySearch");
    e.printStackTrace();
}
```
