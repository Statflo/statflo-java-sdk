...
[**dealerAllowedFeatureGet**](DealerAllowedFeaturesApi.md#dealerAllowedFeatureGet) | **GET** /v4/api/dealer-allowed-feature/{dealer}/{feature} | 
...
try {
    ...
    System.err.println("Exception when calling DealerAllowedFeaturesApi#dealerAllowedFeatureGet");
    e.printStackTrace();
}
```
