...
try {
    ...
    System.err.println("Exception when calling NotificationLogApi#notificationLogDelete");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling NotificationLogApi#notificationLogGet");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling NotificationLogApi#notificationLogSearch");
    e.printStackTrace();
}
```
