...
------------- | ------------- | -------------
[**bulkRequest**](BulkRequestApi.md#bulkRequest) | **POST** /v4/api/bulk | 
...
//import com.statflo.client.api.BulkRequestApi;

ApiClient defaultClient = Configuration.getDefaultApiClient();


BulkRequestApi apiInstance = new BulkRequestApi();
...
try {
    ...
    System.err.println("Exception when calling BulkRequestApi#bulkRequest");
    e.printStackTrace();
}
```
