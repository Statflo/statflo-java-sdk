...
[**bulkMessageSummary**](BulkMessageApi.md#bulkMessageSummary) | **GET** /v4/api/bulk-message/{id}/summary | 
...
try {
    ...
    System.err.println("Exception when calling BulkMessageApi#bulkMessageGet");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling BulkMessageApi#bulkMessageSearch");
    e.printStackTrace();
}
```
...
<a name="bulkMessageSummary"></a>
# **bulkMessageSummary**
> InlineResponse200 bulkMessageSummary(id)



Get delivery summary counts for a Bulk Message.
...
String id = "id_example"; // String | 
try {
    InlineResponse200 result = apiInstance.bulkMessageSummary(id);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling BulkMessageApi#bulkMessageSummary");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling BulkMessageApi#bulkMessageUpdate");
    e.printStackTrace();
}
```
