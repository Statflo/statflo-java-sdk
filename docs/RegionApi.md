...
//import com.statflo.client.api.RegionApi;
...
try {
    ...
    System.err.println("Exception when calling RegionApi#regionDelete");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling RegionApi#regionGet");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling RegionApi#regionSearch");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling RegionApi#regionUpdate");
    e.printStackTrace();
}
```
