...
Statflo API
- SDK version: V4.1.159-hotfix
  - Build date: 2025-10-01T19:13:13.440424108Z[Etc/UTC]
...
<dependency>
  ...
  <version>V4.1.159-hotfix</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.159-hotfix'
}
```
...
* `target/statflo-java-sdk-V4.1.159-hotfix.jar`
* `target/lib/*.jar`
