...
Statflo API
- SDK version: V4.1.138
  - Build date: 2025-06-17T14:08:12.750233894Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.138'
}
```
...
* `target/statflo-java-sdk-V4.1.138.jar`
* `target/lib/*.jar`
