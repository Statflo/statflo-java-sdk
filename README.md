...
Statflo API
- SDK version: dev_20260505165811
  - Build date: 2026-05-05T16:58:19.398472730Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260505165811</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260505165811'
}
```
...
* `target/statflo-java-sdk-dev_20260505165811.jar`
* `target/lib/*.jar`
