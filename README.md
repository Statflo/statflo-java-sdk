...
Statflo API
- SDK version: dev_20260428160828
  - Build date: 2026-04-28T16:08:41.676381854Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260428160828</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260428160828'
}
```
...
* `target/statflo-java-sdk-dev_20260428160828.jar`
* `target/lib/*.jar`
