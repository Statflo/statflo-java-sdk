...
Statflo API
- SDK version: V4.1.146
  - Build date: 2025-07-14T15:44:14.150640740Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.146'
}
```
...
* `target/statflo-java-sdk-V4.1.146.jar`
* `target/lib/*.jar`
