...
Statflo API
- SDK version: V4.1.185
  - Build date: 2026-03-25T13:00:06.851617077Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.185'
}
```
...
* `target/statflo-java-sdk-V4.1.185.jar`
* `target/lib/*.jar`
