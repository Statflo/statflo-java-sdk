...
Statflo API
- SDK version: dev_20260505171829
  - Build date: 2026-05-05T17:18:36.556332344Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260505171829</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260505171829'
}
```
...
* `target/statflo-java-sdk-dev_20260505171829.jar`
* `target/lib/*.jar`
