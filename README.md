...
Statflo API
- SDK version: dev_20260505171039
  - Build date: 2026-05-05T17:10:46.804151134Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260505171039</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260505171039'
}
```
...
* `target/statflo-java-sdk-dev_20260505171039.jar`
* `target/lib/*.jar`
