...
Statflo API
- SDK version: dev_20260304151346
  - Build date: 2026-03-04T15:13:55.064725647Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260304151346</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260304151346'
}
```
...
* `target/statflo-java-sdk-dev_20260304151346.jar`
* `target/lib/*.jar`
