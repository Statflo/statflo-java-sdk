...
Statflo API
- SDK version: V4.1.184
  - Build date: 2026-03-23T20:13:49.514747451Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.184'
}
```
...
* `target/statflo-java-sdk-V4.1.184.jar`
* `target/lib/*.jar`
