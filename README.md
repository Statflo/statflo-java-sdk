...
Statflo API
- SDK version: dev_20260223194516
  - Build date: 2026-02-23T19:45:20.637321898Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260223194516</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260223194516'
}
```
...
* `target/statflo-java-sdk-dev_20260223194516.jar`
* `target/lib/*.jar`
