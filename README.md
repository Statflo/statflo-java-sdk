...
Statflo API
- SDK version: dev_20260430123848
  - Build date: 2026-04-30T12:38:56.817518099Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260430123848</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260430123848'
}
```
...
* `target/statflo-java-sdk-dev_20260430123848.jar`
* `target/lib/*.jar`
...
*CarriersApi* | [**carrierGet**](docs/CarriersApi.md#carrierGet) | **GET** /v4/api/carrier/{id} | 
*CarriersApi* | [**carrierSearch**](docs/CarriersApi.md#carrierSearch) | **GET** /v4/api/carrier | 
...
*EventsApi* | [**events**](docs/EventsApi.md#events) | **GET** /v4/api/event | 
...
*RcsAgentBusinessesApi* | [**rCSAgentBusinessCreate**](docs/RcsAgentBusinessesApi.md#rCSAgentBusinessCreate) | **POST** /v4/api/rcs-agent-business | 
*RcsAgentBusinessesApi* | [**rCSAgentBusinessDelete**](docs/RcsAgentBusinessesApi.md#rCSAgentBusinessDelete) | **DELETE** /v4/api/rcs-agent-business/{id} | 
*RcsAgentBusinessesApi* | [**rCSAgentBusinessGet**](docs/RcsAgentBusinessesApi.md#rCSAgentBusinessGet) | **GET** /v4/api/rcs-agent-business/{id} | 
*RcsAgentBusinessesApi* | [**rCSAgentBusinessSearch**](docs/RcsAgentBusinessesApi.md#rCSAgentBusinessSearch) | **GET** /v4/api/rcs-agent-business | 
*RcsAgentBusinessesApi* | [**rCSAgentBusinessUpdate**](docs/RcsAgentBusinessesApi.md#rCSAgentBusinessUpdate) | **PUT** /v4/api/rcs-agent-business/{id} | 
...
*RcsAgentUseCasesApi* | [**rCSAgentUseCaseCreate**](docs/RcsAgentUseCasesApi.md#rCSAgentUseCaseCreate) | **POST** /v4/api/rcs-agent-use-case | 
*RcsAgentUseCasesApi* | [**rCSAgentUseCaseDelete**](docs/RcsAgentUseCasesApi.md#rCSAgentUseCaseDelete) | **DELETE** /v4/api/rcs-agent-use-case/{id} | 
*RcsAgentUseCasesApi* | [**rCSAgentUseCaseGet**](docs/RcsAgentUseCasesApi.md#rCSAgentUseCaseGet) | **GET** /v4/api/rcs-agent-use-case/{id} | 
*RcsAgentUseCasesApi* | [**rCSAgentUseCaseSearch**](docs/RcsAgentUseCasesApi.md#rCSAgentUseCaseSearch) | **GET** /v4/api/rcs-agent-use-case | 
*RcsAgentUseCasesApi* | [**rCSAgentUseCaseUpdate**](docs/RcsAgentUseCasesApi.md#rCSAgentUseCaseUpdate) | **PUT** /v4/api/rcs-agent-use-case/{id} | 
*RcsAgentsApi* | [**rCSAgentCreate**](docs/RcsAgentsApi.md#rCSAgentCreate) | **POST** /v4/api/rcs-agent | 
*RcsAgentsApi* | [**rCSAgentDelete**](docs/RcsAgentsApi.md#rCSAgentDelete) | **DELETE** /v4/api/rcs-agent/{id} | 
*RcsAgentsApi* | [**rCSAgentGet**](docs/RcsAgentsApi.md#rCSAgentGet) | **GET** /v4/api/rcs-agent/{id} | 
*RcsAgentsApi* | [**rCSAgentSearch**](docs/RcsAgentsApi.md#rCSAgentSearch) | **GET** /v4/api/rcs-agent | 
*RcsAgentsApi* | [**rCSAgentUpdate**](docs/RcsAgentsApi.md#rCSAgentUpdate) | **PUT** /v4/api/rcs-agent/{id} | 
...
*UsersApi* | [**userDelete**](docs/UsersApi.md#userDelete) | **DELETE** /v4/api/user/{id} | 
...
*WidgetsApi* | [**getV4ApiWidgetsCampaigns**](docs/WidgetsApi.md#getV4ApiWidgetsCampaigns) | **GET** /v4/api/widgets/campaigns/{accountId} | 
