...
Statflo API
- SDK version: dev_20260223202751
  - Build date: 2026-02-23T20:28:01.963256690Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260223202751</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260223202751'
}
```
...
* `target/statflo-java-sdk-dev_20260223202751.jar`
* `target/lib/*.jar`
