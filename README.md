...
Statflo API
- SDK version: dev_20260310201203
  - Build date: 2026-03-10T20:12:12.875067932Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260310201203</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260310201203'
}
```
...
* `target/statflo-java-sdk-dev_20260310201203.jar`
* `target/lib/*.jar`
