...
Statflo API
- SDK version: V4.1.189
  - Build date: 2026-04-15T01:14:49.842919653Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.189'
}
```
...
* `target/statflo-java-sdk-V4.1.189.jar`
* `target/lib/*.jar`
