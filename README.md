...
Statflo API
- SDK version: V4.1.163
  - Build date: 2025-10-20T19:08:04.794115153Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.163'
}
```
...
* `target/statflo-java-sdk-V4.1.163.jar`
* `target/lib/*.jar`
