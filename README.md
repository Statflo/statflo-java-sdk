...
Statflo API
- SDK version: V4.1.123
  - Build date: 2025-03-19T01:25:09.456925409Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.123'
}
```
...
* `target/statflo-java-sdk-V4.1.123.jar`
* `target/lib/*.jar`
