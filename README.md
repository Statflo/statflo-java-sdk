...
Statflo API
- SDK version: V4.1.134
  - Build date: 2025-05-20T14:51:57.684743987Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.134'
}
```
...
* `target/statflo-java-sdk-V4.1.134.jar`
* `target/lib/*.jar`
