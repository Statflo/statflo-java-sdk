...
Statflo API
- SDK version: V4.1.156
  - Build date: 2025-09-05T16:58:19.463465145Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.156'
}
```
...
* `target/statflo-java-sdk-V4.1.156.jar`
* `target/lib/*.jar`
