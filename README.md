...
Statflo API
- SDK version: dev_20260407152952
  - Build date: 2026-04-07T15:30:01.292583695Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260407152952</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260407152952'
}
```
...
* `target/statflo-java-sdk-dev_20260407152952.jar`
* `target/lib/*.jar`
