...
Statflo API
- SDK version: dev_20260317135256
  - Build date: 2026-03-17T13:53:03.883444979Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260317135256</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260317135256'
}
```
...
* `target/statflo-java-sdk-dev_20260317135256.jar`
* `target/lib/*.jar`
