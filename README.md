...
Statflo API
- SDK version: dev_20260505151247
  - Build date: 2026-05-05T15:12:57.517112526Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260505151247</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260505151247'
}
```
...
* `target/statflo-java-sdk-dev_20260505151247.jar`
* `target/lib/*.jar`
