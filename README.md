...
Statflo API
- SDK version: dev_20260424131725
  - Build date: 2026-04-24T13:17:31.347010234Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260424131725</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260424131725'
}
```
...
* `target/statflo-java-sdk-dev_20260424131725.jar`
* `target/lib/*.jar`
