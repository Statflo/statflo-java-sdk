...
Statflo API
- SDK version: dev_20260424140050
  - Build date: 2026-04-24T14:00:56.855338518Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260424140050</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260424140050'
}
```
...
* `target/statflo-java-sdk-dev_20260424140050.jar`
* `target/lib/*.jar`
