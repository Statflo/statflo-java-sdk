...
Statflo API
- SDK version: V4.1.116
  - Build date: 2025-01-31T17:10:49.902167468Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.116'
}
```
...
* `target/statflo-java-sdk-V4.1.116.jar`
* `target/lib/*.jar`
