...
Statflo API
- SDK version: V4.1.136
  - Build date: 2025-06-02T17:26:44.033907067Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.136'
}
```
...
* `target/statflo-java-sdk-V4.1.136.jar`
* `target/lib/*.jar`
