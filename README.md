...
Statflo API
- SDK version: V4.1.195
  - Build date: 2026-05-26T13:42:22.633961274Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.195'
}
```
...
* `target/statflo-java-sdk-V4.1.195.jar`
* `target/lib/*.jar`
