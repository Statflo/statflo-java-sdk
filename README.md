...
Statflo API
- SDK version: V4.1.151
  - Build date: 2025-07-28T20:30:53.142284879Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.151'
}
```
...
* `target/statflo-java-sdk-V4.1.151.jar`
* `target/lib/*.jar`
