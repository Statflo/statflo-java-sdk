...
Statflo API
- SDK version: V4.1.133
  - Build date: 2025-05-20T14:40:15.161398518Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.133'
}
```
...
* `target/statflo-java-sdk-V4.1.133.jar`
* `target/lib/*.jar`
