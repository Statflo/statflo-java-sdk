...
Statflo API
- SDK version: V4.1.153
  - Build date: 2025-08-14T01:33:46.008567715Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.153'
}
```
...
* `target/statflo-java-sdk-V4.1.153.jar`
* `target/lib/*.jar`
