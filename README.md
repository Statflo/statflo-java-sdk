...
Statflo API
- SDK version: V4.1.178
  - Build date: 2026-02-17T17:17:29.883329093Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.178'
}
```
...
* `target/statflo-java-sdk-V4.1.178.jar`
* `target/lib/*.jar`
