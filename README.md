...
Statflo API
- SDK version: dev_20260304124416
  - Build date: 2026-03-04T12:44:25.470588905Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260304124416</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260304124416'
}
```
...
* `target/statflo-java-sdk-dev_20260304124416.jar`
* `target/lib/*.jar`
