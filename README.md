...
Statflo API
- SDK version: dev_20260505171556
  - Build date: 2026-05-05T17:16:03.342631439Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260505171556</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260505171556'
}
```
...
* `target/statflo-java-sdk-dev_20260505171556.jar`
* `target/lib/*.jar`
