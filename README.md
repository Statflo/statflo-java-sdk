...
Statflo API
- SDK version: V4.1.192
  - Build date: 2026-05-12T20:13:49.248111118Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.192'
}
```
...
* `target/statflo-java-sdk-V4.1.192.jar`
* `target/lib/*.jar`
