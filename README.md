...
Statflo API
- SDK version: dev_20260505153422
  - Build date: 2026-05-05T15:34:33.585486948Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260505153422</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260505153422'
}
```
...
* `target/statflo-java-sdk-dev_20260505153422.jar`
* `target/lib/*.jar`
