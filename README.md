...
Statflo API
- SDK version: dev_20260319184404
  - Build date: 2026-03-19T18:44:41.597473249Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260319184404</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260319184404'
}
```
...
* `target/statflo-java-sdk-dev_20260319184404.jar`
* `target/lib/*.jar`
