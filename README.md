...
Statflo API
- SDK version: V4.1.116-hotfix
  - Build date: 2025-02-03T19:10:57.619356721Z[Etc/UTC]
...
<dependency>
  ...
  <version>V4.1.116-hotfix</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.116-hotfix'
}
```
...
* `target/statflo-java-sdk-V4.1.116-hotfix.jar`
* `target/lib/*.jar`
