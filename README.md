...
Statflo API
- SDK version: V4.1.159
  - Build date: 2025-10-01T19:11:44.699805095Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.159'
}
```
...
* `target/statflo-java-sdk-V4.1.159.jar`
* `target/lib/*.jar`
