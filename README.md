...
Statflo API
- SDK version: 4.1.187
  - Build date: 2026-04-10T15:08:53.899206862Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:4.1.187'
}
```
...
* `target/statflo-java-sdk-4.1.187.jar`
* `target/lib/*.jar`
