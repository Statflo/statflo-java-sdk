...
Statflo API
- SDK version: V4.1.143
  - Build date: 2025-06-26T14:06:26.938586537Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.143'
}
```
...
* `target/statflo-java-sdk-V4.1.143.jar`
* `target/lib/*.jar`
