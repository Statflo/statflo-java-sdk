...
Statflo API
- SDK version: V4.1.171
  - Build date: 2025-12-08T19:18:05.451596226Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.171'
}
```
...
* `target/statflo-java-sdk-V4.1.171.jar`
* `target/lib/*.jar`
