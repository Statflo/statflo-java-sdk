...
Statflo API
- SDK version: dev_20260305144028
  - Build date: 2026-03-05T14:40:34.445013792Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260305144028</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260305144028'
}
```
...
* `target/statflo-java-sdk-dev_20260305144028.jar`
* `target/lib/*.jar`
