...
Statflo API
- SDK version: V4.1.131
  - Build date: 2025-04-30T00:27:58.451319462Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.131'
}
```
...
* `target/statflo-java-sdk-V4.1.131.jar`
* `target/lib/*.jar`
