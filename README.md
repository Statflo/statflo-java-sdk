...
Statflo API
- SDK version: dev_20260223202529
  - Build date: 2026-02-23T20:25:34.691809573Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260223202529</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260223202529'
}
```
...
* `target/statflo-java-sdk-dev_20260223202529.jar`
* `target/lib/*.jar`
