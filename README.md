...
Statflo API
- SDK version: dev_20260319162948
  - Build date: 2026-03-19T16:29:56.348953419Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260319162948</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260319162948'
}
```
...
* `target/statflo-java-sdk-dev_20260319162948.jar`
* `target/lib/*.jar`
