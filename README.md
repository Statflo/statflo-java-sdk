...
Statflo API
- SDK version: V4.1.152
  - Build date: 2025-08-13T18:20:44.538992232Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.152'
}
```
...
* `target/statflo-java-sdk-V4.1.152.jar`
* `target/lib/*.jar`
