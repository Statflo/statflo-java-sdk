...
Statflo API
- API version: 1.0.0.0
  - Build date: 2024-08-19T11:49:17.592548-04:00[America/Toronto]
...
public class AccountActionsApiExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            AccountAction result = apiInstance.messageTemplateCreate(body);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling AccountActionsApi#messageTemplateCreate");
            e.printStackTrace();
        }
    }
}
...
public class AccountActionsApiExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            AccountAction result = apiInstance.messageTemplateUpdate(id, body);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling AccountActionsApi#messageTemplateUpdate");
            e.printStackTrace();
        }
    }
}
...
*AccountActionsApi* | [**messageTemplateCreate**](docs/AccountActionsApi.md#messageTemplateCreate) | **POST** /v4/api/account-action | 
*AccountActionsApi* | [**messageTemplateUpdate**](docs/AccountActionsApi.md#messageTemplateUpdate) | **PUT** /v4/api/account-action/{id} | 
...
*ContactsApi* | [**contactGet_0**](docs/ContactsApi.md#contactGet_0) | **GET** /v4/api/contacts/{id} | 
*ContactsApi* | [**contactSearch**](docs/ContactsApi.md#contactSearch) | **GET** /v4/api/contact | 
*ContactsApi* | [**contactSearch_0**](docs/ContactsApi.md#contactSearch_0) | **GET** /v4/api/contacts | 
...
*LocationsApi* | [**locationGet**](docs/LocationsApi.md#locationGet) | **GET** /v4/api/outlet/{id} | 
*LocationsApi* | [**locationGet_0**](docs/LocationsApi.md#locationGet_0) | **GET** /v4/api/location/{id} | 
*LocationsApi* | [**locationSearch**](docs/LocationsApi.md#locationSearch) | **GET** /v4/api/outlet | 
*LocationsApi* | [**locationSearch_0**](docs/LocationsApi.md#locationSearch_0) | **GET** /v4/api/location | 
...
*NotepadsApi* | [**notepadGetLatest_0**](docs/NotepadsApi.md#notepadGetLatest_0) | **GET** /v4/api/crm/message/notepad/latest/{accountId} | 
*NotepadsApi* | [**notepadSearch**](docs/NotepadsApi.md#notepadSearch) | **GET** /v4/api/notepad | 
*NotepadsApi* | [**notepadSearch_0**](docs/NotepadsApi.md#notepadSearch_0) | **POST** /v4/api/notepad | 
*NotepadsApi* | [**notepadSearch_1**](docs/NotepadsApi.md#notepadSearch_1) | **POST** /v4/api/crm/message | 
...
*UserTeamsApi* | [**messageTemplateCreate**](docs/UserTeamsApi.md#messageTemplateCreate) | **POST** /v4/api/user-team | 
*UserTeamsApi* | [**messageTemplateDelete**](docs/UserTeamsApi.md#messageTemplateDelete) | **DELETE** /v4/api/user-team/{team}/{user} | 
