...
Statflo API
- SDK version: dev_20260428182526
  - Build date: 2026-04-28T18:25:31.902308574Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260428182526</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260428182526'
}
```
...
* `target/statflo-java-sdk-dev_20260428182526.jar`
* `target/lib/*.jar`
