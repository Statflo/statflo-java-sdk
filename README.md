...
Statflo API
- SDK version: dev_20260505154045
  - Build date: 2026-05-05T15:40:52.714118268Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260505154045</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260505154045'
}
```
...
* `target/statflo-java-sdk-dev_20260505154045.jar`
* `target/lib/*.jar`
