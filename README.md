...
Statflo API
- SDK version: dev_20260304211129
  - Build date: 2026-03-04T21:11:35.941716971Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260304211129</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260304211129'
}
```
...
* `target/statflo-java-sdk-dev_20260304211129.jar`
* `target/lib/*.jar`
