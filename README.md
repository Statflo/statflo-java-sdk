...
Statflo API
- SDK version: V4.1.151-hotfix
  - Build date: 2025-08-13T18:19:30.769293547Z[Etc/UTC]
...
<dependency>
  ...
  <version>V4.1.151-hotfix</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.151-hotfix'
}
```
...
* `target/statflo-java-sdk-V4.1.151-hotfix.jar`
* `target/lib/*.jar`
