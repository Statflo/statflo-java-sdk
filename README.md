...
Statflo API
- SDK version: dev_20260505154134
  - Build date: 2026-05-05T15:41:41.190792641Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260505154134</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260505154134'
}
```
...
* `target/statflo-java-sdk-dev_20260505154134.jar`
* `target/lib/*.jar`
