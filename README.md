...
Statflo API
- SDK version: dev_20260407154127
  - Build date: 2026-04-07T15:41:33.056316266Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260407154127</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260407154127'
}
```
...
* `target/statflo-java-sdk-dev_20260407154127.jar`
* `target/lib/*.jar`
