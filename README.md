...
Statflo API
- SDK version: V4.1.172
  - Build date: 2025-12-08T20:23:22.632072386Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.172'
}
```
...
* `target/statflo-java-sdk-V4.1.172.jar`
* `target/lib/*.jar`
