...
Statflo API
- SDK version: V4.1.154
  - Build date: 2025-09-05T16:53:45.261425165Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.154'
}
```
...
* `target/statflo-java-sdk-V4.1.154.jar`
* `target/lib/*.jar`
