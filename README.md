...
Statflo API
- SDK version: dev_20260505172138
  - Build date: 2026-05-05T17:21:51.687746289Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260505172138</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260505172138'
}
```
...
* `target/statflo-java-sdk-dev_20260505172138.jar`
* `target/lib/*.jar`
