...
Statflo API
- SDK version: V4.1.192-hotfix
  - Build date: 2026-05-19T16:03:34.467887459Z[Etc/UTC]
...
<dependency>
  ...
  <version>V4.1.192-hotfix</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.192-hotfix'
}
```
...
* `target/statflo-java-sdk-V4.1.192-hotfix.jar`
* `target/lib/*.jar`
