...
Statflo API
- SDK version: dev_20260408133806
  - Build date: 2026-04-08T13:38:14.666961066Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260408133806</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260408133806'
}
```
...
* `target/statflo-java-sdk-dev_20260408133806.jar`
* `target/lib/*.jar`
