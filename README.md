...
Statflo API
- SDK version: V4.1.181
  - Build date: 2026-02-27T19:56:48.679859804Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.181'
}
```
...
* `target/statflo-java-sdk-V4.1.181.jar`
* `target/lib/*.jar`
