...
Statflo API
- SDK version: V4.1.174
  - Build date: 2026-01-05T17:23:55.242405910Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.174'
}
```
...
* `target/statflo-java-sdk-V4.1.174.jar`
* `target/lib/*.jar`
