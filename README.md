...
Statflo API
- SDK version: V4.1.135
  - Build date: 2025-05-21T13:48:15.743418469Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.135'
}
```
...
* `target/statflo-java-sdk-V4.1.135.jar`
* `target/lib/*.jar`
