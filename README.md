...
Statflo API
- SDK version: dev_20260407181317
  - Build date: 2026-04-07T18:13:25.660744537Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260407181317</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260407181317'
}
```
...
* `target/statflo-java-sdk-dev_20260407181317.jar`
* `target/lib/*.jar`
