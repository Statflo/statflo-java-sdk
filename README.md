...
Statflo API
- SDK version: dev_20260505152458
  - Build date: 2026-05-05T15:25:07.913877312Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260505152458</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260505152458'
}
```
...
* `target/statflo-java-sdk-dev_20260505152458.jar`
* `target/lib/*.jar`
