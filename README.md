...
Statflo API
- SDK version: dev_20260305183016
  - Build date: 2026-03-05T18:30:27.408983910Z[Etc/UTC]
...
<dependency>
  ...
  <version>dev_20260305183016</version>
</dependency>
```
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:dev_20260305183016'
}
```
...
* `target/statflo-java-sdk-dev_20260305183016.jar`
* `target/lib/*.jar`
