...
Statflo API
- SDK version: V4.1.160
  - Build date: 2025-10-20T18:55:44.340936126Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.160'
}
```
...
* `target/statflo-java-sdk-V4.1.160.jar`
* `target/lib/*.jar`
