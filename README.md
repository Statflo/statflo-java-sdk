...
Statflo API
- SDK version: V4.1.169
  - Build date: 2025-11-13T14:45:09.295208529Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.169'
}
```
...
* `target/statflo-java-sdk-V4.1.169.jar`
* `target/lib/*.jar`
