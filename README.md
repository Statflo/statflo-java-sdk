...
Statflo API
- SDK version: V4.1.164
  - Build date: 2025-10-20T19:09:20.266558164Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.164'
}
```
...
* `target/statflo-java-sdk-V4.1.164.jar`
* `target/lib/*.jar`
