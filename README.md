...
Statflo API
- SDK version: V4.1.132
  - Build date: 2025-05-08T01:15:31.536065992Z[Etc/UTC]
...
```groovy
dependencies {
        implementation 'com.github.Statflo:statflo-java-sdk:V4.1.132'
}
```
...
* `target/statflo-java-sdk-V4.1.132.jar`
* `target/lib/*.jar`
