...
import io.swagger.client.model.MessageTemplateAssignment;
...
public class MessageTemplateAssignmentsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call messageTemplateAssignmentSearchCall(List<String> filter, String query, Integer page, Integer perPage, String sort, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call messageTemplateAssignmentSearchValidateBeforeCall(List<String> filter, String query, Integer page, Integer perPage, String sort, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public MessageTemplateAssignmentPaginationResponse messageTemplateAssignmentSearch(List<String> filter, String query, Integer page, Integer perPage, String sort) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<MessageTemplateAssignmentPaginationResponse> messageTemplateAssignmentSearchWithHttpInfo(List<String> filter, String query, Integer page, Integer perPage, String sort) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call messageTemplateAssignmentSearchAsync(List<String> filter, String query, Integer page, Integer perPage, String sort, final ApiCallback<MessageTemplateAssignmentPaginationResponse> callback) throws ApiException {
