...
import com.statflo.client.model.UserCreate;
import com.statflo.client.model.UserPaginationResponse;
import com.statflo.client.model.UserUpdate;
...
public class UserApi {
    ...
    /**
     * Build call for postV4ApiUserSearch
     * @param body  (optional)
     ...
     */
    public com.squareup.okhttp.Call postV4ApiUserSearchCall(UserCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call postV4ApiUserSearchValidateBeforeCall(UserCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = postV4ApiUserSearchCall(body, progressListener, progressRequestListener);
        return call;
     ...
     */
    public User postV4ApiUserSearch(UserCreate body) throws ApiException {
        ApiResponse<User> resp = postV4ApiUserSearchWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<User> postV4ApiUserSearchWithHttpInfo(UserCreate body) throws ApiException {
        com.squareup.okhttp.Call call = postV4ApiUserSearchValidateBeforeCall(body, null, null);
     ...
     */
    public com.squareup.okhttp.Call postV4ApiUserSearchAsync(UserCreate body, final ApiCallback<User> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postV4ApiUserSearchValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<User>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call userUpdateCall(String id, UserUpdate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call userUpdateValidateBeforeCall(String id, UserUpdate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling userUpdate(Async)");
        }
        
        com.squareup.okhttp.Call call = userUpdateCall(id, body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public User userUpdate(String id, UserUpdate body) throws ApiException {
        ApiResponse<User> resp = userUpdateWithHttpInfo(id, body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<User> userUpdateWithHttpInfo(String id, UserUpdate body) throws ApiException {
        com.squareup.okhttp.Call call = userUpdateValidateBeforeCall(id, body, null, null);
        Type localVarReturnType = new TypeToken<User>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call userUpdateAsync(String id, UserUpdate body, final ApiCallback<User> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = userUpdateValidateBeforeCall(id, body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<User>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
