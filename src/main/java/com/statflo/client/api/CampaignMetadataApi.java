...
public class CampaignMetadataApi {
    ...
    /**
     * Build call for postV4ApiCampaignMetadataSearch
     * @param body  (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postV4ApiCampaignMetadataSearchCall(CampaignMetadataCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postV4ApiCampaignMetadataSearchValidateBeforeCall(CampaignMetadataCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = postV4ApiCampaignMetadataSearchCall(body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public CampaignMetadata postV4ApiCampaignMetadataSearch(CampaignMetadataCreate body) throws ApiException {
        ApiResponse<CampaignMetadata> resp = postV4ApiCampaignMetadataSearchWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CampaignMetadata> postV4ApiCampaignMetadataSearchWithHttpInfo(CampaignMetadataCreate body) throws ApiException {
        com.squareup.okhttp.Call call = postV4ApiCampaignMetadataSearchValidateBeforeCall(body, null, null);
        Type localVarReturnType = new TypeToken<CampaignMetadata>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postV4ApiCampaignMetadataSearchAsync(CampaignMetadataCreate body, final ApiCallback<CampaignMetadata> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postV4ApiCampaignMetadataSearchValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CampaignMetadata>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
