...
public class RegionApi {
    ...
    /**
     * Build call for postV4ApiRegionSearch
     * @param body  (optional)
     ...
     */
    public com.squareup.okhttp.Call postV4ApiRegionSearchCall(RegionCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call postV4ApiRegionSearchValidateBeforeCall(RegionCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = postV4ApiRegionSearchCall(body, progressListener, progressRequestListener);
        return call;
     ...
     */
    public Region postV4ApiRegionSearch(RegionCreate body) throws ApiException {
        ApiResponse<Region> resp = postV4ApiRegionSearchWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Region> postV4ApiRegionSearchWithHttpInfo(RegionCreate body) throws ApiException {
        com.squareup.okhttp.Call call = postV4ApiRegionSearchValidateBeforeCall(body, null, null);
     ...
     */
    public com.squareup.okhttp.Call postV4ApiRegionSearchAsync(RegionCreate body, final ApiCallback<Region> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postV4ApiRegionSearchValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Region>(){}.getType();
