...
public class CampaignApi {
    ...
    /**
     * Build call for postV4ApiCampaignsSearch
     * @param body  (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postV4ApiCampaignsSearchCall(CampaignCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postV4ApiCampaignsSearchValidateBeforeCall(CampaignCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = postV4ApiCampaignsSearchCall(body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Campaign postV4ApiCampaignsSearch(CampaignCreate body) throws ApiException {
        ApiResponse<Campaign> resp = postV4ApiCampaignsSearchWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Campaign> postV4ApiCampaignsSearchWithHttpInfo(CampaignCreate body) throws ApiException {
        com.squareup.okhttp.Call call = postV4ApiCampaignsSearchValidateBeforeCall(body, null, null);
        Type localVarReturnType = new TypeToken<Campaign>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postV4ApiCampaignsSearchAsync(CampaignCreate body, final ApiCallback<Campaign> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postV4ApiCampaignsSearchValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Campaign>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
