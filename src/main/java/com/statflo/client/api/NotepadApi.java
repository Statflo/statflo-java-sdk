...
public class NotepadApi {
    ...
    public NotepadApi(ApiClient apiClient) {
    ...
    /**
     * Build call for postV4ApiNotepadSearch
     * @param body  (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postV4ApiNotepadSearchCall(NotepadCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postV4ApiNotepadSearchValidateBeforeCall(NotepadCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = postV4ApiNotepadSearchCall(body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Notepad postV4ApiNotepadSearch(NotepadCreate body) throws ApiException {
        ApiResponse<Notepad> resp = postV4ApiNotepadSearchWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Notepad> postV4ApiNotepadSearchWithHttpInfo(NotepadCreate body) throws ApiException {
        com.squareup.okhttp.Call call = postV4ApiNotepadSearchValidateBeforeCall(body, null, null);
        Type localVarReturnType = new TypeToken<Notepad>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postV4ApiNotepadSearchAsync(NotepadCreate body, final ApiCallback<Notepad> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postV4ApiNotepadSearchValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Notepad>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
