...
public class AccountActionApi {
    private ApiClient apiClient;
    private Map<String, String> headers;

    public AccountActionApi() {
        this(Configuration.getDefaultApiClient());
    }

    public AccountActionApi(ApiClient apiClient) {
    ...
    /**
     * Build call for postV4ApiAccountActionSearch
     * @param body  (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postV4ApiAccountActionSearchCall(AccountActionCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postV4ApiAccountActionSearchValidateBeforeCall(AccountActionCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = postV4ApiAccountActionSearchCall(body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public AccountAction postV4ApiAccountActionSearch(AccountActionCreate body) throws ApiException {
        ApiResponse<AccountAction> resp = postV4ApiAccountActionSearchWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AccountAction> postV4ApiAccountActionSearchWithHttpInfo(AccountActionCreate body) throws ApiException {
        com.squareup.okhttp.Call call = postV4ApiAccountActionSearchValidateBeforeCall(body, null, null);
        Type localVarReturnType = new TypeToken<AccountAction>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postV4ApiAccountActionSearchAsync(AccountActionCreate body, final ApiCallback<AccountAction> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postV4ApiAccountActionSearchValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AccountAction>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
