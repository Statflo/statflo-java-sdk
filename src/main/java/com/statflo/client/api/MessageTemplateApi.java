...
public class MessageTemplateApi {
    ...
    public MessageTemplateApi(ApiClient apiClient) {
    ...
    /**
     * Build call for postV4ApiMessageTemplateSearch
     * @param body  (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postV4ApiMessageTemplateSearchCall(MessageTemplateCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postV4ApiMessageTemplateSearchValidateBeforeCall(MessageTemplateCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = postV4ApiMessageTemplateSearchCall(body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public MessageTemplate postV4ApiMessageTemplateSearch(MessageTemplateCreate body) throws ApiException {
        ApiResponse<MessageTemplate> resp = postV4ApiMessageTemplateSearchWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<MessageTemplate> postV4ApiMessageTemplateSearchWithHttpInfo(MessageTemplateCreate body) throws ApiException {
        com.squareup.okhttp.Call call = postV4ApiMessageTemplateSearchValidateBeforeCall(body, null, null);
        Type localVarReturnType = new TypeToken<MessageTemplate>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postV4ApiMessageTemplateSearchAsync(MessageTemplateCreate body, final ApiCallback<MessageTemplate> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postV4ApiMessageTemplateSearchValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<MessageTemplate>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
