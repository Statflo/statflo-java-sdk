...
public class NotepadsApi {
    ...
    /**
     * Build call for crmMessageCreate
     * @param body  (optional)
     ...
     */
    public com.squareup.okhttp.Call crmMessageCreateCall(NotepadCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call crmMessageCreateValidateBeforeCall(NotepadCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = crmMessageCreateCall(body, progressListener, progressRequestListener);
        return call;
     ...
     */
    public Notepad crmMessageCreate(NotepadCreate body) throws ApiException {
        ApiResponse<Notepad> resp = crmMessageCreateWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Notepad> crmMessageCreateWithHttpInfo(NotepadCreate body) throws ApiException {
        com.squareup.okhttp.Call call = crmMessageCreateValidateBeforeCall(body, null, null);
     ...
     */
    public com.squareup.okhttp.Call crmMessageCreateAsync(NotepadCreate body, final ApiCallback<Notepad> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = crmMessageCreateValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Notepad>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for crmMessageGetLatest
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call crmMessageGetLatestCall(String accountId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call crmMessageGetLatestValidateBeforeCall(String accountId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'accountId' is set
        if (accountId == null) {
            throw new ApiException("Missing the required parameter 'accountId' when calling crmMessageGetLatest(Async)");
        }
        
        com.squareup.okhttp.Call call = crmMessageGetLatestCall(accountId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Notepad crmMessageGetLatest(String accountId) throws ApiException {
        ApiResponse<Notepad> resp = crmMessageGetLatestWithHttpInfo(accountId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Notepad> crmMessageGetLatestWithHttpInfo(String accountId) throws ApiException {
        com.squareup.okhttp.Call call = crmMessageGetLatestValidateBeforeCall(accountId, null, null);
        Type localVarReturnType = new TypeToken<Notepad>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call crmMessageGetLatestAsync(String accountId, final ApiCallback<Notepad> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = crmMessageGetLatestValidateBeforeCall(accountId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Notepad>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
