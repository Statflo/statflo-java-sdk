...
import com.statflo.client.model.CampaignPropertyCreate;
import com.statflo.client.model.CampaignPropertyPaginationResponse;
import com.statflo.client.model.CampaignPropertyUpdate;
...
public class CampaignPropertyApi {
    private ApiClient apiClient;
    private Map<String, String> headers;

    public CampaignPropertyApi() {
        this(Configuration.getDefaultApiClient());
    }

    public CampaignPropertyApi(ApiClient apiClient) {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call campaignPropertyUpdateCall(String id, CampaignPropertyUpdate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call campaignPropertyUpdateValidateBeforeCall(String id, CampaignPropertyUpdate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public CampaignProperty campaignPropertyUpdate(String id, CampaignPropertyUpdate body) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CampaignProperty> campaignPropertyUpdateWithHttpInfo(String id, CampaignPropertyUpdate body) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call campaignPropertyUpdateAsync(String id, CampaignPropertyUpdate body, final ApiCallback<CampaignProperty> callback) throws ApiException {
    ...
    /**
     * Build call for postV4ApiCampaignPropertySearch
     * @param body  (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postV4ApiCampaignPropertySearchCall(CampaignPropertyCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postV4ApiCampaignPropertySearchValidateBeforeCall(CampaignPropertyCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = postV4ApiCampaignPropertySearchCall(body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public CampaignProperty postV4ApiCampaignPropertySearch(CampaignPropertyCreate body) throws ApiException {
        ApiResponse<CampaignProperty> resp = postV4ApiCampaignPropertySearchWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CampaignProperty> postV4ApiCampaignPropertySearchWithHttpInfo(CampaignPropertyCreate body) throws ApiException {
        com.squareup.okhttp.Call call = postV4ApiCampaignPropertySearchValidateBeforeCall(body, null, null);
        Type localVarReturnType = new TypeToken<CampaignProperty>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postV4ApiCampaignPropertySearchAsync(CampaignPropertyCreate body, final ApiCallback<CampaignProperty> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postV4ApiCampaignPropertySearchValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CampaignProperty>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
