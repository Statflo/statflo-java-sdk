...
public class CampaignPropertyApi {
     ...
     */
    public com.squareup.okhttp.Call campaignPropertyCreateCall(CampaignPropertyCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call campaignPropertyCreateValidateBeforeCall(CampaignPropertyCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     */
    public CampaignProperty campaignPropertyCreate(CampaignPropertyCreate body) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CampaignProperty> campaignPropertyCreateWithHttpInfo(CampaignPropertyCreate body) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call campaignPropertyCreateAsync(CampaignPropertyCreate body, final ApiCallback<CampaignProperty> callback) throws ApiException {
