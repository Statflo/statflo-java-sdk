...
public class UsersApi {
     ...
     */
    public com.squareup.okhttp.Call userCreateCall(UserCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call userCreateValidateBeforeCall(UserCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = userCreateCall(body, progressListener, progressRequestListener);
        return call;
     ...
     */
    public User userCreate(UserCreate body) throws ApiException {
        ApiResponse<User> resp = userCreateWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<User> userCreateWithHttpInfo(UserCreate body) throws ApiException {
        com.squareup.okhttp.Call call = userCreateValidateBeforeCall(body, null, null);
     ...
     */
    public com.squareup.okhttp.Call userCreateAsync(UserCreate body, final ApiCallback<User> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = userCreateValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<User>(){}.getType();
