...
public class DealerAllowedFeatureApi {
    private ApiClient apiClient;
    private Map<String, String> headers;

    public DealerAllowedFeatureApi() {
        this(Configuration.getDefaultApiClient());
    }

    public DealerAllowedFeatureApi(ApiClient apiClient) {
    ...
    /**
     * Build call for dealerAllowedFeatureGet
     * @param dealer  (required)
     * @param feature  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call dealerAllowedFeatureGetCall(String dealer, String feature, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call dealerAllowedFeatureGetValidateBeforeCall(String dealer, String feature, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'dealer' is set
        if (dealer == null) {
            throw new ApiException("Missing the required parameter 'dealer' when calling dealerAllowedFeatureGet(Async)");
        }
        // verify the required parameter 'feature' is set
        if (feature == null) {
            throw new ApiException("Missing the required parameter 'feature' when calling dealerAllowedFeatureGet(Async)");
        }
        
        com.squareup.okhttp.Call call = dealerAllowedFeatureGetCall(dealer, feature, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public DealerAllowedFeature dealerAllowedFeatureGet(String dealer, String feature) throws ApiException {
        ApiResponse<DealerAllowedFeature> resp = dealerAllowedFeatureGetWithHttpInfo(dealer, feature);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<DealerAllowedFeature> dealerAllowedFeatureGetWithHttpInfo(String dealer, String feature) throws ApiException {
        com.squareup.okhttp.Call call = dealerAllowedFeatureGetValidateBeforeCall(dealer, feature, null, null);
        Type localVarReturnType = new TypeToken<DealerAllowedFeature>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call dealerAllowedFeatureGetAsync(String dealer, String feature, final ApiCallback<DealerAllowedFeature> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = dealerAllowedFeatureGetValidateBeforeCall(dealer, feature, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<DealerAllowedFeature>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
