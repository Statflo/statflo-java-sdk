...
public class UserExternalIdApi {
    ...
    /**
     * Build call for postV4ApiUserExternalIdSearch
     * @param body  (optional)
     ...
     */
    public com.squareup.okhttp.Call postV4ApiUserExternalIdSearchCall(UserExternalIdCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call postV4ApiUserExternalIdSearchValidateBeforeCall(UserExternalIdCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = postV4ApiUserExternalIdSearchCall(body, progressListener, progressRequestListener);
        return call;
     ...
     */
    public UserExternalId postV4ApiUserExternalIdSearch(UserExternalIdCreate body) throws ApiException {
        ApiResponse<UserExternalId> resp = postV4ApiUserExternalIdSearchWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<UserExternalId> postV4ApiUserExternalIdSearchWithHttpInfo(UserExternalIdCreate body) throws ApiException {
        com.squareup.okhttp.Call call = postV4ApiUserExternalIdSearchValidateBeforeCall(body, null, null);
     ...
     */
    public com.squareup.okhttp.Call postV4ApiUserExternalIdSearchAsync(UserExternalIdCreate body, final ApiCallback<UserExternalId> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postV4ApiUserExternalIdSearchValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<UserExternalId>(){}.getType();
    ...
    /**
     * Build call for userExternalIdSearch
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call userExternalIdSearchCall(java.util.HashMap filter, String query, Integer page, Integer perPage, String sort, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call userExternalIdSearchValidateBeforeCall(java.util.HashMap filter, String query, Integer page, Integer perPage, String sort, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = userExternalIdSearchCall(filter, query, page, perPage, sort, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public UserExternalIdPaginationResponse userExternalIdSearch(java.util.HashMap filter, String query, Integer page, Integer perPage, String sort) throws ApiException {
        ApiResponse<UserExternalIdPaginationResponse> resp = userExternalIdSearchWithHttpInfo(filter, query, page, perPage, sort);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<UserExternalIdPaginationResponse> userExternalIdSearchWithHttpInfo(java.util.HashMap filter, String query, Integer page, Integer perPage, String sort) throws ApiException {
        com.squareup.okhttp.Call call = userExternalIdSearchValidateBeforeCall(filter, query, page, perPage, sort, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call userExternalIdSearchAsync(java.util.HashMap filter, String query, Integer page, Integer perPage, String sort, final ApiCallback<UserExternalIdPaginationResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = userExternalIdSearchValidateBeforeCall(filter, query, page, perPage, sort, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<UserExternalIdPaginationResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
