...
public class MessageTemplateAssignmentApi {
    private ApiClient apiClient;
    private Map<String, String> headers;

    public MessageTemplateAssignmentApi() {
        this(Configuration.getDefaultApiClient());
    }

    public MessageTemplateAssignmentApi(ApiClient apiClient) {
    ...
    /**
     * Build call for postV4ApiMessageTemplateAssignmentSearch
     * @param body  (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postV4ApiMessageTemplateAssignmentSearchCall(MessageTemplateAssignmentCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postV4ApiMessageTemplateAssignmentSearchValidateBeforeCall(MessageTemplateAssignmentCreate body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = postV4ApiMessageTemplateAssignmentSearchCall(body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public MessageTemplateAssignment postV4ApiMessageTemplateAssignmentSearch(MessageTemplateAssignmentCreate body) throws ApiException {
        ApiResponse<MessageTemplateAssignment> resp = postV4ApiMessageTemplateAssignmentSearchWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<MessageTemplateAssignment> postV4ApiMessageTemplateAssignmentSearchWithHttpInfo(MessageTemplateAssignmentCreate body) throws ApiException {
        com.squareup.okhttp.Call call = postV4ApiMessageTemplateAssignmentSearchValidateBeforeCall(body, null, null);
        Type localVarReturnType = new TypeToken<MessageTemplateAssignment>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postV4ApiMessageTemplateAssignmentSearchAsync(MessageTemplateAssignmentCreate body, final ApiCallback<MessageTemplateAssignment> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postV4ApiMessageTemplateAssignmentSearchValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<MessageTemplateAssignment>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
