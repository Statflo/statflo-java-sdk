...
public class User {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, username, firstName, lastName, email, language, salesRepId, outletId, districtId, regionId, phoneNumber, timezone, theme, userActive, inboundAvailable, dealer, userPermissions, userTeams, dateAdded, permissions);
  }
