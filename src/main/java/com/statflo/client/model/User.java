...
public class User {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, username, firstName, lastName, company, email, password, language, salesRepId, externalLocationId, districtId, regionId, phoneNumber, timezone, theme, userActive, inboundAvailable, jobTitle, acceptedTermsConditions, appointmentReminderEmail, dealer, role, userPermissions, userTeams, userMetadata, dateAdded, campaignVisibility, permissions, outletId);
  }
