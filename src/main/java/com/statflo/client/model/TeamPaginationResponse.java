...
public class TeamPaginationResponse {
  ...
  public TeamPaginationResponse items(List<TeamSummary> items) {
    this.items = items;
    return this;
  }

  public TeamPaginationResponse addItemsItem(TeamSummary itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<TeamSummary>();
    }
  ...
  **/
  @Schema(description = "")
  public List<TeamSummary> getItems() {
    return items;
  }

  public void setItems(List<TeamSummary> items) {
    this.items = items;
  }
